...
<head>
    ...
    <title>OwlShare - Mis solicitudes</title>
    ...
    <div class="max-w-3xl mx-auto">
        <div class="mb-8">
            ...
            <p class="text-on-surface-variant text-sm sm:text-base">
                Consulta el estado de cada tutoría que has solicitado.
            </p>
        </div>
        ...
        <c:choose>
                        ...
                        <article class="bg-surface-container-lowest rounded-xl p-6
                            ...
                            <div class="flex flex-wrap items-start justify-between gap-3 mb-4">
                                <div>
                                    <h2 class="font-bold text-on-surface text-lg">
                                        <c:out value="${s.tutor.nombreCompleto}"/>
                                    </h2>
                                    <p class="text-xs text-outline mt-1">
                                        <c:out value="${s.tutor.email}"/>
                                    </p>
                                </div>
                                <c:choose>
                            ...
                            <div class="space-y-2 text-sm">
                                ...
                                <c:if test="${not empty s.mensaje}">
                                    <p>
                                        <span class="text-outline text-xs font-bold uppercase tracking-wider">Tu mensaje</span><br/>
            ...
            <c:otherwise>
                <div class="bg-surface-container-lowest rounded-xl shadow-[0_20px_40px_rgba(25,28,30,0.08)] p-12 text-center">
                    ...
                    <p class="text-on-surface-variant mb-4">Aún no has enviado solicitudes de tutoría.</p>
        ...
        <a href="${pageContext.request.contextPath}/estudiante?ruta=inicio"
           class="inline-flex items-center gap-2 text-sm font-bold text-primary hover:underline mt-8">
